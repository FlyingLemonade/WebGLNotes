...
function main() {
    ...
    var tubeData = generateSphere(0, 0, 0.5, 0.5, 50); // Example sphere: x=0, y=0, z=0.5, radius=0.5, segments=50
    ...
    var animate = function (time) {
        ...
        GL.drawElements(GL.LINE_STRIP, tubeData.faces.length, GL.UNSIGNED_SHORT, 0);
